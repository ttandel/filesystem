// file provided by the instructor of a course
...
//      System.exit(0);
	   ...
	   PackableMemory p = new PackableMemory(4);
	   p.pack(2147483647, 0);
	   System.out.println(Arrays.toString(p.getByteArray()));
	   System.out.println(p.unpack(0));
   }
*/ 
   // ---------------------------------------------------------------
   // ---------------------------------------------------------------
